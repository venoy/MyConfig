--
-- liubin awesome config file, rc.lua
...
for s = 1, screen.count() do
    ...
    -- awful.layout.set(layouts[12], tags[s][1])
--     awful.layout.set(layouts[2], tags[s][5])
--     awful.layout.set(layouts[2], tags[s][8])
--     awful.layout.set(layouts[6], tags[s][9])
...
tags[1][5].name = " 5.FLOATING"
tags[1][6].name = " 6.REMOTE"
